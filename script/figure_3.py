...
def main():
    ...
    for dist in tqdm(distances, desc="Simulating sequence pairs in different distances: "):
        for _ in tqdm(range(num_pairs), desc="Calculating one distances value by different pairs: "):
            ...
            p_hat_kmer = calculate_match_probability(seq1, seq2, show_all_F_k, single_seq, method="basic_kmer")
            ...
            p_hat_spaced = calculate_match_probability(seq1, seq2, show_all_F_k, single_seq, method="spaced_word")
